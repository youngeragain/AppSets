...
private const val TAG = "WaveSlider"
...
fun WaveSlider(
    ...
    thumb: @Composable () -> Unit = { CircleThumb() },
    steps: Int = 0
) {
    ...
    val infiniteTransition = rememberInfiniteTransition(label = "wave_infinite_transition")
    val phaseShiftFloat = infiniteTransition.animateFloat(
        label = "wave_phase_shift_animate",
        initialValue = 0F,
