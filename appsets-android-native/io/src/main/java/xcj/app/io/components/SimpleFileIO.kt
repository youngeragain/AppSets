...
class SimpleFileIO private constructor() : FileIO {
    ...
    private fun getUpdateResultListener(): CosXmlResultListener {
        return object : CosXmlResultListener {
            override fun onSuccess(request: CosXmlRequest, result: CosXmlResult) {
                ...
                Log.e("SimpleFileIO", "uploadReturnUrlMarker, onSuccess")
            }
    ...
    private fun uploadReturnUrlMarker(
        ...
        runBlocking {
            ...
            Log.e("SimpleFileIO", "compressed image file:${compressedFile}")
    ...
    override fun uploadWithUri(
        ...
        if (uri.scheme == "file") {
            ...
            Log.e("SimpleFileIO", "uploadWithUri uri content file path:${file}")
        ...
        cursor?.use {
            ...
            Log.e("SimpleFileIO", "uploadWithUri uri content file path:${filePath}")
    ...
    fun generatePreSign(contentUrlMarker: String): String? {
        if (!::tencentCosInfoProvider.isInitialized) {
            Log.e("SimpleFileIO", "tencentCosInfoProvider is not init when generatePreSign")
            return null
        }
        if (cosXmlService == null) {
            Log.e("SimpleFileIO", "cosXmlService is null when generatePreSign")
            return null
        }
        try {
            val tencentCosRegionBucket = tencentCosInfoProvider.getTencentCosRegionBucket()
            ...
            Log.e("SimpleFileIO", "generatePreSign presignedURL:${presignedURL}")
            return presignedURL
