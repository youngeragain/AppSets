...
object PageRouteNameProvider {
    ...
    const val ConversationDetailsMorePage = "Main/ConversationDetailsMorePage"
    const val GroupConversationPage = "Main/GroupConversationPage"
    const val AddScreenPostPage = "Main/AddScreenPostPage"
    const val AppDetailsPage = "Main/AppDetailsPage"
    const val CreateGroup = "Main/CreateGroup"
}
