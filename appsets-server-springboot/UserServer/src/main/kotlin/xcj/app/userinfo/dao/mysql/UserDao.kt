...
import xcj.app.userinfo.model.table.mysql.User
...
interface UserDao {
    ...
    fun addUser(uid:String,
                ...
                address:String?,
                website:String?):Int
    fun getUserInfoByUid(uid:String):UserInfoRes
    fun getUserInfoList(uids:List<String>):List<UserInfoRes>
    ...
    fun searchUserByKeywords(accountEncFromKeywords:String, keywords:String, limit:Int, offset:Int):List<UserInfoRes>
