...
import xcj.app.userinfo.service.ChatGroupService


@RequestMapping("/user")
@RestController
class UserChatGroupController(private val simpleChatGroupServiceImpl: ChatGroupService) {

    @ApiDesignPermission.LoginRequired
    @ApiDesignPermission.VersionRequired(200)
    @GetMapping("chatgroup/{groupId}")
    fun getUserChatGroupInfo(@PathVariable(name = "groupId") groupId: String):DesignResponse<GroupInfoRes>{
    ...
    fun getUserChatGroupInfoList(
        @RequestHeader(name = ApiDesignEncodeStr.tokenStrToMd5) token: String):DesignResponse<List<GroupInfoRes>>{
    ...
    fun getUserChatGroupInfoListAdmin(@PathVariable("userId") userId: String):DesignResponse<List<GroupInfoRes>>{
    ...
    fun getUserIdsInChatGroup(@PathVariable(name = "groupId") groupId: String):DesignResponse<List<String>>{
    ...
    fun createGroup(@RequestBody createGroupParams: CreateGroupParams,
    ...
    fun createGroupPreCheck(@RequestParam(name = "name") groupName: String,
                    @RequestHeader(name = ApiDesignEncodeStr.tokenStrToMd5) token:String):DesignResponse<Boolean>{
    ...
    fun deleteGroup(@RequestBody deleteGroupParams: DeleteGroupParams):DesignResponse<Boolean>{
    ...
    fun deleteUsersInGroup(@RequestBody deleteUsersInGroupParams: DeleteUsersInGroupParams):DesignResponse<Boolean>{
    ...
    fun requestJoinGroupFeedback(@RequestBody requestJoinGroupFeedbackParams: RequestJoinGroupFeedbackParams):DesignResponse<Boolean>{
    ...
    fun requestJoinGroup(
        ...
        @RequestBody requestJoinGroupParams: RequestJoinGroupParams):DesignResponse<String?>{
